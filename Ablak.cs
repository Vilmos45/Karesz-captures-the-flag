...
namespace Karesz
{
    public partial class Form1
    {
        ...
        static int idő = 0;
        static int[] színkódok = new int[] { üres, fal, fekete, piros, zöld, kék, hó, láva, víz, kek_padlo, piros_padlo, fold };
        static string[] színnév = new string[] { "üres", "fal", "fekete", "piros", "zöld", "kék", "hó", "láva", "víz", "kek_padlo", "piros", "föld" };
        static Color[] színek = { Color.White, Color.Brown, Color.Black, Color.Red, Color.Green, Color.Blue, Color.White, Color.Orange, Color.Blue, Color.Blue, Color.Red, Color.Green };
